...
`)
	...
	fmt.Fprintln(w, "\tovh:\tONLINE_ENDPOINT, ONLINE_TOKEN")
	...
	fmt.Fprintln(w, "\tonline:\tONLINE_POLLING_INTERVAL, ONLINE_PROPAGATION_TIMEOUT, ONLINE_TTL, ONLINE_HTTP_TIMEOUT")
