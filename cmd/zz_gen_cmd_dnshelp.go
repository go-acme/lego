...
func displayDNSHelp(w io.Writer, name string) error {
	...
	case "openprovider":
		...
		ew.writeln(`	- "OPENPROVIDER_POLLING_INTERVAL":	Time between DNS propagation check in seconds (Default: 2)`)
		ew.writeln(`	- "OPENPROVIDER_PROPAGATION_TIMEOUT":	Maximum waiting time for DNS propagation in seconds (Default: 60)`)
