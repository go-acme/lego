...
func displayDNSHelp(w io.Writer, name string) error {
	...
	case "ionoscloud":
		...
		ew.writeln(`Credentials:`)
		ew.writeln(`	- "IONOSCLOUD_TOKEN":	Bearer token for the Public DNS API (see https://api.ionos.com/docs/dns/v1/)`)
		ew.writeln()
		...
		ew.writeln(`	- "IONOSCLOUD_PROPAGATION_TIMEOUT":	Maximum waiting time for DNS propagation in seconds (Default: 900)`)
		ew.writeln(`	- "IONOSCLOUD_TTL":	The TTL of the TXT record used for the DNS challenge in seconds (Default: 300)`)
