...
func displayDNSHelp(w io.Writer, name string) error {
	...
	case "hostup":
		...
		ew.writeln(`Since:	'v4.36.0'`)
		ew.writeln()

		ew.writeln(`Credentials:`)
		ew.writeln(`	- "HOSTUP_API_KEY":	API key with read:dns, write:dns, and read:domains scopes`)
		ew.writeln()
		...
		ew.writeln(`	- "HOSTUP_TTL":	The TTL of the TXT record used for the DNS challenge in seconds (Default: 60)`)
