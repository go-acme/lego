...
func displayDNSHelp(w io.Writer, name string) error {
	...
	case "rackcorp":
		...
		ew.writeln(`Credentials:`)
		ew.writeln(`	- "RACKCORP_API_SECRET":	API secret`)
		ew.writeln(`	- "RACKCORP_API_UUID":	API UUID`)
		ew.writeln()

		ew.writeln(`Additional Configuration:`)
		ew.writeln(`	- "RACKCORP_HTTP_TIMEOUT":	API request timeout in seconds (Default: 30)`)
