...
<!-- providers/dns/nitrado/nitrado.toml -->
<!-- THIS DOCUMENTATION IS AUTO-GENERATED. PLEASE DO NOT EDIT. -->


Configuration for [Nitrado](https://server.nitrado.net/).
...
Here is an example bash command using the Nitrado provider:
...
- [API documentation](https://doc.nitrado.net/)
