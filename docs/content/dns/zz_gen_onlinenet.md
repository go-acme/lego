...
| `ONLINENET_POLLING_INTERVAL` | Time between DNS propagation check in seconds (Default: 2) |
| `ONLINENET_PROPAGATION_TIMEOUT` | Maximum waiting time for DNS propagation in seconds (Default: 60) |
