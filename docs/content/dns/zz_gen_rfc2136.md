...
| `RFC2136_TSIG_GSS_KEYTAB_PATH` | Path to Kerberos keytab file. The TSIG algorithm must be `gss-tsig.`. |
| `RFC2136_TSIG_GSS_PASSWORD` | GSS password. The TSIG algorithm must be `gss-tsig.`. |
