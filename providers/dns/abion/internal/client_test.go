...
func TestUpdateZone(t *testing.T) {
	...
	client := mockBuilder().Route("PATCH /v1/zones/"+domain,
		servermock.ResponseFromFixture("update.json"),
		servermock.CheckRequestJSONBodyFromFile("update-request.json")).
		Build(t)
...
func TestGetZones(t *testing.T) {
	client := mockBuilder().Route("GET /v1/zones/",
...
func TestGetZone(t *testing.T) {
	...
	client := mockBuilder().Route("GET /v1/zones/"+domain,
