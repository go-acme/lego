...
func TestClient_ListRecords(t *testing.T) {
	client := servermock2.NewBuilder[*Client](setupClient).
		Route("GET /dns_list",
			servermock2.ResponseFromFixture("dns_list.json"),
...
func TestClient_ListRecords_error(t *testing.T) {
	client := servermock2.NewBuilder[*Client](setupClient).
		Route("GET /dns_list",
			servermock2.ResponseFromFixture("dns_list_error.json").
...
func TestClient_DeleteRecord(t *testing.T) {
	client := servermock2.NewBuilder[*Client](setupClient).
		Route("GET /dns_delete",
			servermock2.ResponseFromFixture("dns_delete.json"),
			servermock2.CheckQueryParameter().Strict().
				With("id", "74749").
				With("domain", "example.com").
				With("nichdl", "user").
...
func TestClient_DeleteRecord_error(t *testing.T) {
	client := servermock2.NewBuilder[*Client](setupClient).
		Route("GET /dns_delete",
			servermock2.ResponseFromFixture("dns_delete_error.json").
				WithStatusCode(http.StatusNotFound)).
		Build(t)
...
func TestClient_AddRecord(t *testing.T) {
	client := servermock2.NewBuilder[*Client](setupClient).
		Route("GET /dns_add",
			servermock2.ResponseFromFixture("dns_add.json"),
			servermock2.CheckQueryParameter().Strict().
				With("id", "74749").
				With("domain", "example.com").
				With("nichdl", "user").
...
func TestClient_AddRecord_error(t *testing.T) {
	client := servermock2.NewBuilder[*Client](setupClient).
		Route("GET /dns_add",
			servermock2.ResponseFromFixture("dns_add_error.json").
				WithStatusCode(http.StatusNotFound)).
		Build(t)
