...
func TestTxtRecordService_Create(t *testing.T) {
	client := mockBuilder().
		Route("POST /v1/domains/12345/records/txt", servermock2.ResponseFromFixture("records-Create.json"),
			servermock2.CheckRequestJSONBody(`{"name":""}`)).
		Build(t)
...
func TestTxtRecordService_GetAll(t *testing.T) {
	client := mockBuilder().
		Route("GET /v1/domains/12345/records/txt", servermock2.ResponseFromFixture("records-GetAll.json")).
		Build(t)
...
func TestTxtRecordService_Get(t *testing.T) {
	client := mockBuilder().
		Route("GET /v1/domains/12345/records/txt/6789", servermock2.ResponseFromFixture("records-Get.json")).
		Build(t)
...
func TestTxtRecordService_Update(t *testing.T) {
	client := mockBuilder().
		Route("PUT /v1/domains/12345/records/txt/6789",
			servermock2.RawStringResponse(`{"success":"Record  updated successfully"}`)).
		Build(t)
...
func TestTxtRecordService_Delete(t *testing.T) {
	client := mockBuilder().
		Route("DELETE /v1/domains/12345/records/txt/6789",
			servermock2.RawStringResponse(`{"success":"Record  deleted successfully"}`)).
		Build(t)
...
func TestTxtRecordService_Search(t *testing.T) {
	client := mockBuilder().
		Route("GET /v1/domains/12345/records/txt/search", servermock2.ResponseFromFixture("records-Search.json")).
		Build(t)
