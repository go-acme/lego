...
import (
	...
	"github.com/go-acme/lego/v5/providers/dns/dnsmint/internal"
...
func (d *DNSProvider) Present(ctx context.Context, domain, token, keyAuth string) error {
	...
	err := d.client.Add(ctx, data)
	if err != nil {
		return fmt.Errorf("dnsmint: add record: %w", err)
	}
...
func (d *DNSProvider) CleanUp(ctx context.Context, domain, token, keyAuth string) error {
	...
	err := d.client.Remove(ctx, data)
	if err != nil {
		return fmt.Errorf("dnsmint: remove record: %w", err)
	}
