...
func TestNewDNSProvider(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			envVars:  map[string]string{},
			expected: "fornex: some credentials information are missing: FORNEX_API_KEY",
		},
	}
...
func TestNewDNSProviderConfig(t *testing.T) {
	testCases := []struct {
		...
		{
			desc:     "missing credentials",
			expected: "fornex: credentials missing",
		},
	}
