...
func (c *Client) GetZone(ctx context.Context, idName string) (*Zone, error) {
	endpoint := c.BaseURL.JoinPath("zones", idName)
...
// GetRRSet gets a RRSet.
// https://docs.hetzner.cloud/reference/cloud#zone-rrsets-get-an-rrset
func (c *Client) GetRRSet(ctx context.Context, zoneIDName, recordType, recordName string) (*RRSet, error) {
	endpoint := c.BaseURL.JoinPath("zones", zoneIDName, "rrsets", recordName, recordType)
...
// CreateRRSet creates an RRSet.
// https://docs.hetzner.cloud/reference/cloud#zone-rrsets-create-an-rrset
func (c *Client) CreateRRSet(ctx context.Context, zoneIDName string, rrset RRSet) (*RRSet, error) {
	endpoint := c.BaseURL.JoinPath("zones", zoneIDName, "rrsets")
...
// SetRRSetRecords sets the records of an RRSet.
// https://docs.hetzner.cloud/reference/cloud#zone-rrset-actions-set-records-of-an-rrset
func (c *Client) SetRRSetRecords(ctx context.Context, zoneIDName, recordType, recordName string, records []Record) (*Action, error) {
	endpoint := c.BaseURL.JoinPath("zones", zoneIDName, "rrsets", recordName, recordType, "actions", "set_records")
