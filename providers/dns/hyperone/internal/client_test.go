...
func TestClient_FindRecordset(t *testing.T) {
	client := mockBuilder().
		Route("GET /dns/loc123/project/proj123/zone/zone321/recordset",
			clientmock.ResponseFromFixture("recordset.json")).
		Build(t)
...
func TestClient_CreateRecordset(t *testing.T) {
	...
	client := mockBuilder().
		Route("POST /dns/loc123/project/proj123/zone/zone123/recordset",
			clientmock.ResponseFromFixture("createRecordset.json"),
			clientmock.CheckRequestJSONBodyFromStruct(expectedReqBody)).
		Build(t)
...
func TestClient_CreateRecord(t *testing.T) {
	...
	client := mockBuilder().
		Route("POST /dns/loc123/project/proj123/zone/z123/recordset/rs325/record",
			clientmock.ResponseFromFixture("createRecord.json"),
			clientmock.CheckRequestJSONBodyFromStruct(expectedReqBody)).
		Build(t)
