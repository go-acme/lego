...
func mockBuilder() *servermock2.Builder[*Client] {
	return servermock2.NewBuilder[*Client](
		...
		servermock2.CheckHeader().With(APIKeyHeader, "secret"))
}

func TestClient_ListZones(t *testing.T) {
	client := mockBuilder().
		Route("GET /v1/zones",
			servermock2.ResponseFromFixture("list_zones.json")).
		Build(t)
...
func TestClient_ListZones_error(t *testing.T) {
	client := mockBuilder().
		Route("GET /v1/zones",
			servermock2.ResponseFromFixture("list_zones_error.json").
...
func TestClient_GetRecords_error(t *testing.T) {
	client := mockBuilder().
		Route("GET /v1/zones/azone01",
			servermock2.ResponseFromFixture("get_records_error.json").
				WithStatusCode(http.StatusUnauthorized)).
		Build(t)
...
func TestClient_RemoveRecord_error(t *testing.T) {
	client := mockBuilder().
		Route("DELETE /v1/zones/azone01/records/arecord01",
			servermock2.ResponseFromFixture("remove_record_error.json").
...
func TestClient_ReplaceRecords_error(t *testing.T) {
	client := mockBuilder().
		Route("PATCH /v1/zones/azone01",
			servermock2.ResponseFromFixture("replace_records_error.json").
