...
func TestClient_AddRecord_error(t *testing.T) {
	client := servermock2.NewBuilder[*Client](setupClient).
		Route("POST /api",
			servermock2.ResponseFromFixture("add_record-error.json").
...
func TestClient_DeleteRecord(t *testing.T) {
	client := servermock2.NewBuilder[*Client](setupClient,
		...
		Route("DELETE /api",
			...
			servermock2.ResponseFromFixture("del_record.json").
...
func TestClient_DeleteRecord_error(t *testing.T) {
	client := servermock2.NewBuilder[*Client](setupClient).
		Route("DELETE /api",
			servermock2.ResponseFromFixture("del_record-error.json").
				WithStatusCode(http.StatusBadRequest)).
		Build(t)
