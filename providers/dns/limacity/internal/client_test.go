...
func TestClient_GetDomains(t *testing.T) {
	client := mockBuilder().
		Route("GET /domains.json", clientmock.ResponseFromFixture("get-domains.json")).
		Build(t)
...
func TestClient_GetRecords(t *testing.T) {
	client := mockBuilder().
		Route("GET /domains/123/records.json", clientmock.ResponseFromFixture("get-records.json")).
		Build(t)
...
func TestClient_AddRecord(t *testing.T) {
	client := mockBuilder().
		Route("POST /domains/123/records.json",
			clientmock.ResponseFromFixture("ok.json"),
			clientmock.CheckRequestJSONBody(`{"nameserver_record":{"name":"foo","content":"bar","ttl":12,"type":"TXT"}}`)).
		Build(t)
...
func TestClient_UpdateRecord(t *testing.T) {
	client := mockBuilder().
		Route("PUT /domains/123/records/456",
			clientmock.ResponseFromFixture("ok.json"),
			clientmock.CheckRequestJSONBody(`{"nameserver_record":{}}`)).
		Build(t)
