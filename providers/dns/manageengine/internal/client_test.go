...
func TestClient_GetAllZones(t *testing.T) {
	client := mockBuilder().
		Route("GET /dns/domain", stubrouter.ResponseFromFixture("zone_domains_all.json")).
		Build(t)
...
func TestClient_GetAllZoneRecords(t *testing.T) {
	client := mockBuilder().
		Route("GET /dns/domain/4/records/SPF_TXT", stubrouter.ResponseFromFixture("zone_records_all.json")).
		Build(t)
...
func TestClient_DeleteZoneRecord(t *testing.T) {
	client := mockBuilder().
		Route("DELETE /dns/domain/4/records/SPF_TXT/6", stubrouter.ResponseFromFixture("zone_record_delete.json")).
		Build(t)
...
func TestClient_CreateZoneRecord(t *testing.T) {
	client := mockBuilder().
		Route("POST /dns/domain/4/records/SPF_TXT/",
			stubrouter.ResponseFromFixture("zone_record_create.json"),
			stubrouter.CheckHeader().
...
func TestClient_UpdateZoneRecord(t *testing.T) {
	client := mockBuilder().
		Route("PUT /dns/domain/4/records/SPF_TXT/6/",
			stubrouter.ResponseFromFixture("zone_record_update.json"),
			stubrouter.CheckHeader().
				WithContentTypeFromURLEncoded(),
			stubrouter.CheckForm().Strict().
