...
func TestClient_GetAllZones(t *testing.T) {
	client := mockBuilder().
		Route("GET /dns/domain", clientmock.ResponseFromFixture("zone_domains_all.json")).
		Build(t)
...
func TestClient_GetAllZoneRecords(t *testing.T) {
	client := mockBuilder().
		Route("GET /dns/domain/4/records/SPF_TXT", clientmock.ResponseFromFixture("zone_records_all.json")).
		Build(t)
...
func TestClient_DeleteZoneRecord(t *testing.T) {
	client := mockBuilder().
		Route("DELETE /dns/domain/4/records/SPF_TXT/6", clientmock.ResponseFromFixture("zone_record_delete.json")).
		Build(t)
...
func TestClient_CreateZoneRecord(t *testing.T) {
	client := mockBuilder().
		Route("POST /dns/domain/4/records/SPF_TXT/",
			clientmock.ResponseFromFixture("zone_record_create.json"),
			clientmock.CheckHeader().
...
func TestClient_CreateZoneRecord_error_bad_request(t *testing.T) {
	client := mockBuilder().
		Route("POST /dns/domain/4/records/SPF_TXT/",
			clientmock.ResponseFromFixture("error_bad_request.json").
...
func TestClient_UpdateZoneRecord(t *testing.T) {
	client := mockBuilder().
		Route("PUT /dns/domain/4/records/SPF_TXT/6/",
			clientmock.ResponseFromFixture("zone_record_update.json"),
			clientmock.CheckHeader().
				WithContentTypeFromURLEncoded(),
			clientmock.CheckForm().Strict().
