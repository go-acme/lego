...
func NewClient(httpClient *http.Client, serviceName string) (*Client, error) {
	if serviceName == "" {
...
func (c *Client) GetRecords(ctx context.Context, zoneName string) ([]RR, error) {
	endpoint := c.baseURL.JoinPath("services", c.serviceName, "zones", zoneName, "records")
...
func (c *Client) DeleteRecord(ctx context.Context, zoneName string, id string) error {
	endpoint := c.baseURL.JoinPath("services", c.serviceName, "zones", zoneName, "records", id)
...
func (c *Client) CommitZone(ctx context.Context, zoneName string) error {
	endpoint := c.baseURL.JoinPath("services", c.serviceName, "zones", zoneName, "commit")
...
func (c *Client) AddRecords(ctx context.Context, zoneName string, rrs []RR) ([]Zone, error) {
	endpoint := c.baseURL.JoinPath("services", c.serviceName, "zones", zoneName, "records")
