...
func TestClient_GetSite(t *testing.T) {
	client := mockBuilder().
		Route("POST /enterprise/control/agent.php", clientmock.ResponseFromFixture("get-site.xml")).
		Build(t)
...
func TestClient_GetSite_error(t *testing.T) {
	client := mockBuilder().
		Route("POST /enterprise/control/agent.php", clientmock.ResponseFromFixture("get-site-error.xml")).
		Build(t)
...
func TestClient_GetSite_system_error(t *testing.T) {
	client := mockBuilder().
		Route("POST /enterprise/control/agent.php", clientmock.ResponseFromFixture("global-error.xml")).
		Build(t)
...
func TestClient_AddRecord(t *testing.T) {
	client := mockBuilder().
		Route("POST /enterprise/control/agent.php", clientmock.ResponseFromFixture("add-record.xml")).
		Build(t)
...
func TestClient_AddRecord_error(t *testing.T) {
	client := mockBuilder().
		Route("POST /enterprise/control/agent.php", clientmock.ResponseFromFixture("add-record-error.xml")).
		Build(t)
...
func TestClient_DeleteRecord(t *testing.T) {
	client := mockBuilder().
		Route("POST /enterprise/control/agent.php", clientmock.ResponseFromFixture("delete-record.xml")).
		Build(t)
...
func TestClient_DeleteRecord_error(t *testing.T) {
	client := mockBuilder().
		Route("POST /enterprise/control/agent.php", clientmock.ResponseFromFixture("delete-record-error.xml")).
		Build(t)
