...
func TestIdentifier_Login(t *testing.T) {
	identifier := servermock2.NewBuilder[*Identifier](setupIdentifier, servermock2.CheckHeader().WithJSONHeaders()).
		Route("POST /", servermock2.ResponseFromFixture("tokens.json")).
		Build(t)
