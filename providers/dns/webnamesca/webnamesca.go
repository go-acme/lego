...
import (
	...
	"github.com/go-acme/lego/v5/providers/dns/webnamesca/internal"
)
...
func (d *DNSProvider) Present(domain, token, keyAuth string) error {
	...
	_, err = d.client.AddTXTRecord(ctx, dnsnew.UnFqdn(authZone), dnsnew.UnFqdn(info.EffectiveFQDN), info.Value)
	if err != nil {
...
func (d *DNSProvider) CleanUp(domain, token, keyAuth string) error {
	...
	_, err = d.client.DeleteTXTRecord(ctx, dnsnew.UnFqdn(authZone), dnsnew.UnFqdn(info.EffectiveFQDN), info.Value)
	if err != nil {
