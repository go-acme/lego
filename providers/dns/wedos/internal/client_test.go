...
func TestClient_GetRecords(t *testing.T) {
	client := mockBuilder().
		Route("POST /",
			servermock2.ResponseFromFixture(commandDNSRowsList+".json"),
...
func TestClient_AddRecord(t *testing.T) {
	client := mockBuilder().
		Route("POST /",
			servermock2.ResponseFromFixture(commandDNSRowAdd+".json"),
...
func TestClient_AddRecord_update(t *testing.T) {
	client := mockBuilder().
		Route("POST /",
			servermock2.ResponseFromFixture(commandDNSRowUpdate+".json"),
...
func TestClient_DeleteRecord(t *testing.T) {
	client := mockBuilder().
		Route("POST /",
			servermock2.ResponseFromFixture(commandDNSRowDelete+".json"),
...
func TestClient_Commit(t *testing.T) {
	client := mockBuilder().
		Route("POST /",
			servermock2.ResponseFromFixture(commandDNSDomainCommit+".json"),
...
func checkFormRequest(data string) servermock2.LinkFunc {
